...
@Component
public class TopDealsListener extends AbstractMongoEventListener<TopDeals> {

	@Autowired
	private SequenceGeneratorService sequenceGenerator;
	
	@Autowired
    public TopDealsListener(SequenceGeneratorService sequenceGenerator) {
        this.sequenceGenerator = sequenceGenerator;
    }
	
	@Override
    public void onBeforeConvert(BeforeConvertEvent<TopDeals> event) {
